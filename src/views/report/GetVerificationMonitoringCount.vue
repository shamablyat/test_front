...
const isByRegionAllowed = ref(auth.permissions.includes("VerificationMonitoringCountReportViewByRegion"));
const isByDistrictAllowed = ref(auth.permissions.includes("VerificationMonitoringCountReportViewByDistrict"));
...
const refresh = () => {
  ...
  ReportService.GetVerificationMonitoringCount(innerFilter)
    .then((res: any) => {
...
const printReport = () => {
  ...
  ReportService.ExportVerificationMonitoringCount(filter)
    .then((res: any) => {
