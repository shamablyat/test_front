...
const isByRegionAllowed = ref(auth.permissions.includes("AssistantServiceReportReportByRegion"));
const isByDistrictAllowed = ref(auth.permissions.includes("AssistantServiceReportReportByDistrict"));
...
const refresh = () => {
  ...
  ReportService.GetAssistantServices(innerFilter)
    .then((res: any) => {
...
const printReport = () => {
  ...
  ReportService.ExportAssistantServices(filter)
    .then((res: any) => {
      printLoading.value = false;
      forceFileDownload(res, t("GetAssistantServices"), ".xlsx");
    })
    .catch((err: any) => {
      setError(err);
      printLoading.value = false;
