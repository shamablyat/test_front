...
const permission = "IndividualProgram";
const routerName = "IndividualProgram";
...
const fields: IFields[] = [
  ...
  { key: "individualProgramType", label: "individualProgramType", sort: true },
...
<template>
  <UiParentCard>
    <form-table :fields="fields" :filter="filter" :service="IndividualProgramService" :routerName="routerName" :permission="permission" append-action>
      <template #header="{ refresh, getData }">
        <form-table-header :filter="filter" @refresh="refresh" @edit="edit" @getData="getData" :permission="permission" @clear-filter="clearFilter" />
      </template>
      <template #actions="{ item, refresh }">
        <FormTableActions
          :item="item"
          :actions="actions"
          :service="IndividualProgramService"
