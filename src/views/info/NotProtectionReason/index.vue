...
import NotProtectionReasonService from "@/services/info/NotProtectionReason.service";
import { reactive } from "vue";
import { useRouter } from "vue-router";

const router = useRouter();
const permission = "NotProtectionReason";
const routerName = "NotProtectionReason";
...
<template>
  <UiParentCard>
    <form-table
      :fields="fields"
      :filter="filter"
      :service="NotProtectionReasonService"
