...
import LivingConditionService from "@/services/info/LivingCondition.service";
import { reactive } from "vue";
import { useRouter } from "vue-router";

const router = useRouter();
const permission = "LivingCondition";
const routerName = "LivingCondition";
...
<template>
  <UiParentCard>
    <form-table :fields="fields" :filter="filter" :service="LivingConditionService" :routerName="routerName" :permission="permission" append-action>
      <template #header="{ refresh, getData }">
        <form-table-header :filter="filter" @refresh="refresh" @getData="getData" @edit="edit" :permission="permission" @clear-filter="clearFilter" />
      </template>
      <template #actions="{ item, refresh }">
        <FormTableActions
          ...
          :service="LivingConditionService"
          @refresh="refresh"
          @edit="edit"
          @view="view"
        />
